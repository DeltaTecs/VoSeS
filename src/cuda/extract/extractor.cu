...
__global__ void quic_app_traffic_secret_0_scan_gcm128_sha256_kernel(const unsigned char* d_haystack, const uint64_t haystack_length,
    ...
    bool isMatch = cuda_match_quic_app_traffic_secret_0_gcm128_sha256(candidate, TLS13_APP_TRAFFIC_SECRET_0_LEN_SHA256,
...
__global__ void quic_app_traffic_secret_0_scan_gcm256_sha384_kernel(const unsigned char* d_haystack, const uint64_t haystack_length,
    ...
    bool isMatch = cuda_match_quic_app_traffic_secret_0_gcm256_sha384(candidate, TLS13_APP_TRAFFIC_SECRET_0_LEN_SHA384,
                                                                      d_packet, packet_length, pn_offset);
    if (isMatch) {
        printf("\nMatch has entropy %f\n", entropy);
        *d_addr_found = percentile_index;
...
static void print_tls13_app_traffic_secret_0(const unsigned char* secret, int secret_len,
...
__host__ unsigned long long tls13_app_traffic_secret_0_helper(const unsigned char* haystack, const uint64_t haystack_length,
    ...
    uint16_t record_len = (static_cast<uint16_t>(app_data_record[3]) << 8) | static_cast<uint16_t>(app_data_record[4]);
...
__host__ unsigned long long tls12_master_secret_gcm_128_sha_256_scan(const unsigned char* haystack, const uint64_t haystack_length,
    ...
    return tls12_master_secret_helper(haystack, haystack_length, client_random, server_random, client_finished_msg, client_finished_length, entropyThreshold, tls12_master_secret_scan_gcm128_sha256_kernel);
}
...
__host__ unsigned long long tls12_master_secret_gcm_256_sha_384_scan(const unsigned char* haystack, const uint64_t haystack_length,
    ...
    return tls12_master_secret_helper(haystack, haystack_length, client_random, server_random, client_finished_msg, client_finished_length, entropyThreshold, tls12_master_secret_scan_gcm256_sha384_kernel);
}
...
// TLS 1.3 Application Traffic Secret 0 Scan GCM 256 SHA 384
...
// QUIC Application Traffic Secret 0 Scan GCM 128 SHA 256
__host__ unsigned long long quic_app_traffic_secret_0_gcm_128_sha_256_scan(const unsigned char* haystack, const uint64_t haystack_length,
    ...
    return quic_app_traffic_secret_0_helper(haystack, haystack_length, packet, packet_length,
        pn_offset, client_random, entropyThreshold, client, TLS13_APP_TRAFFIC_SECRET_0_LEN_SHA256,
        quic_app_traffic_secret_0_scan_gcm128_sha256_kernel);
}

// QUIC Application Traffic Secret 0 Scan GCM 256 SHA 384
__host__ unsigned long long quic_app_traffic_secret_0_gcm_256_sha_384_scan(const unsigned char* haystack, const uint64_t haystack_length,
    ...
    return quic_app_traffic_secret_0_helper(haystack, haystack_length, packet, packet_length,
        pn_offset, client_random, entropyThreshold, client, TLS13_APP_TRAFFIC_SECRET_0_LEN_SHA384,
